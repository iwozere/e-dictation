...
- When UI gets updated increase the version number, shown on the screen. To bump the version after a deploy, change both pubspec.yaml (version: 0.2.0+2) and AppConfig.version ('0.2.0'). Users can hard-refresh if they see a stale version number.
...
## Overview
Short description of the module's purpose and responsibilities within the e-dictation platform.
...
## Purpose
Describe why this module exists and its role in the e-dictation platform.
